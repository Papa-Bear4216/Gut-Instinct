...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final GenaiLibraryAccessors laccForGenaiLibraryAccessors = new GenaiLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>genai</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public GenaiLibraryAccessors getGenai() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForGenaiLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class GenaiLibraryAccessors extends SubDependencyFactory {

        public GenaiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>prompt</b> with <b>com.google.mlkit:genai-prompt</b> coordinates and
         * with version reference <b>genai.prompt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getPrompt() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("genai.prompt");
        }
    ...
    public static class LintLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>lint</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final GenaiVersionAccessors vaccForGenaiVersionAccessors = new GenaiVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>lint</b> with value <b>31.5.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.genai</b>
         */
        public GenaiVersionAccessors getGenai() {
            return vaccForGenaiVersionAccessors;
        }
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>33.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class GenaiVersionAccessors extends VersionFactory  {

        public GenaiVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>genai.prompt</b> with value <b>1.0.0-beta2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPrompt() { return getVersion("genai.prompt"); }
